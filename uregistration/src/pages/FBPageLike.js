...
import PageLikeCard from '../components/PageLikeCard';
...
class FBPageLike extends React.Component {
    ...
    componentDidMount() {
        ...
        if (user != null) {
            ...
            pointService.getServicePoints("Facebook Page Like").then(res => {
                ...
                <div>
                    ...
                    <div class="main" style={{ height: "100%", backgroundColor: "#dfeef2" }}>
                        ...
                        <div class="s-layout">
                            ...
                            <main class="s-layout__content" style={{ marginTop: "10px" }}>
                                <div className="row mb-5">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div className="row d-flex flex-row py-5" id="fbdatacard">
                                            <div className="w-100 px-4 d-flex flex-row flex-wrap align-items-center justify-content-between">
                                            ...
                                            {currentCountries.map(country => <PageLikeCard key={country.id} country={country} count={this.state.points} handleClick={this.handleClick} />)}
