...
class ServeyList extends React.Component {
    ...
    componentDidMount() {
        ...
        if (user != null) {
            ...
            pointService.getServicePoints("Servey Fill").then(res => {
    ...
    getpageData() {
        serveyService.getServeys(Cookies.get('user'))
            .then(res => {
    ...
    handleClick = (urlS) => {
        ...
        let fblike = { userid: Cookies.get('user'), service: "Servey Fill", orderid: urlS.id }
        ...
        socialmedia.addFacebookLike(fblike)
            .then(res => {
                if (res.data === "exceed") {
                    ...
                    window.location="/serveyview?servey="+urlS.id;
                    // this.OpenRedirect("/serveyview?servey="+urlS.id);
                                        ...
                                        <div className="row d-flex flex-row py-5" id="fbdatacard">
                                            <div className="w-100 px-4 d-flex flex-row flex-wrap align-items-center justify-content-between">
                                                <div className="d-flex flex-row align-items-center">
                                                    ...
                                                    <strong className="text-secondary" style={{ textAlign: "center",marginTop:"50px" }}>No Surveys Available</strong>
                                ...
                                <div className="row mb-5">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        <div className="row d-flex flex-row py-5" id="fbdatacard">
                                            <div className="w-100 px-4 d-flex flex-row flex-wrap align-items-center justify-content-between">
                                                <div className="d-flex flex-row align-items-center">
                                                    ...
                                                    <h2 className={headerClass} >
                                                        <strong className="text-secondary" style={{ textAlign: "center" }}>{totalCountries}</strong> Surveys Available
    </h2>
                                            ...
                                            {currentCountries.map(country => <ServeyCard key={country.id} country={country} count={this.state.points} handleClick={this.handleClick} />)}
