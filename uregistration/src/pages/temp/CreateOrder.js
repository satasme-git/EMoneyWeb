...
class Dash extends React.Component {
  ...
  componentDidMount() {
    ...
    earningService
      .getTotalEarning(sessionStorage.getItem("user"))
      .then((res) => {
  ...
  generateYoutubePrice(val, changecol) {
    ...
    if (y_v_check.checked && y_s_check.checked) {
      ...
      orderService
        .getprices(social, service, count, sessionStorage.getItem("user"))
        .then((res) => {
          this.setState({
  ...
  generateFacebookPrice(val, changecol) {
    ...
    if (f_pol_check.checked && f_pal_check.checked && f_s_check.checked) {
      ...
      if (changecol === "pal") {
        var count =
          val + "," + this.state.f_Polikes + "," + this.state.f_shares;
      } else if (changecol === "pol") {
        var count =
          this.state.f_Palikes + "," + val + "," + this.state.f_shares;
      } else {
        var count =
          this.state.f_Palikes + "," + this.state.f_Polikes + "," + val;
      }
  ...
  changeYoutubeViewsStatus = (event) => {
    ...
    var agegrouptag = document.getElementById("y_v_agegroup");
  ...
  changeYoutubesubscribeStatus = (event) => {
    ...
    var agegrouptag = document.getElementById("y_s_agegroup");
  ...
  changeFacebookPostlikeStatus = (event) => {
    ...
    var agegrouptag = document.getElementById("f_pol_agegroup");
  ...
  changeFacebookPagelikeStatus = (event) => {
    ...
    var agegrouptag = document.getElementById("f_pal_agegroup");
  ...
  changeFacebookShareStatus = (event) => {
    ...
    var agegrouptag = document.getElementById("f_s_agegroup");
  ...
  checkoutOrder = (e) => {
    ...
    if (menu1.classList.contains("active")) {
      var y_v_check = document.getElementById("y_v_check");
      var y_s_check = document.getElementById("y_s_check");
      var vcountry = document.getElementById("y_v_country").value;
      var vagegroup = document.getElementById("y_v_agegroup").value;
      ...
      var scountry = document.getElementById("y_s_country").value;
      var sagegroup = document.getElementById("y_s_agegroup").value;
      ...
      if (y_v_check.checked && y_s_check.checked) {
        let orderdetails = {
          ...
          country: vcountry + "," + scountry,
          social: "youtube",
          agegroup: vagegroup + "," + sagegroup,
          gender: vgender + "," + sgender,
          link: this.state.youtube_link,
          cost: 50.0,
          service: "views,subscribers",
          count: this.state.y_views + "," + this.state.y_subscribe,
        };
      ...
      var f_pal_check = document.getElementById("f_pal_check");
      var f_s_check = document.getElementById("f_s_check");
      var polcountry = document.getElementById("f_pol_country").value;
      var palcountry = document.getElementById("f_pal_country").value;
      var scountry = document.getElementById("f_s_country").value;
      ...
      if (f_pol_check.checked && f_pal_check.checked && f_s_check.checked) {
        let orderdetails = {
          user: sessionStorage.getItem("user"),
          country: polcountry + "," + palcountry + "," + scountry,
          social: "facebook",
          agegroup: polagegroup + "," + palagegroup + "," + sagegroup,
          gender: polgender + "," + palgender + "," + sgender,
          link: this.state.facebook_link,
          cost: 50.0,
          service: "post likes,page likes,shares",
          count:
            this.state.f_Polikes +
            "," +
            this.state.f_Palikes +
            "," +
            this.state.f_shares,
        };
        ...
        let orderdetails = {
          user: sessionStorage.getItem("user"),
          country: polcountry + "," + palcountry,
          social: "facebook",
          agegroup: polagegroup + "," + palagegroup,
          gender: polgender + "," + palgender,
          link: this.state.facebook_link,
          cost: 50.0,
          service: "post likes,page likes",
          count: this.state.f_Polikes + "," + this.state.f_Palikes,
        };
        ...
        let orderdetails = {
          user: sessionStorage.getItem("user"),
          country: polcountry + "," + scountry,
          social: "facebook",
          agegroup: polagegroup + "," + sagegroup,
          gender: polgender + "," + sgender,
          link: this.state.facebook_link,
          cost: 50.0,
          service: "post likes,shares",
          count: this.state.f_Polikes + "," + this.state.f_shares,
        };
        ...
        let orderdetails = {
          user: sessionStorage.getItem("user"),
          country: palcountry + "," + scountry,
          social: "facebook",
          agegroup: palagegroup + "," + sagegroup,
          gender: palgender + "," + sgender,
          link: this.state.facebook_link,
          cost: 50.0,
          service: "page likes,shares",
          count: this.state.f_Palikes + "," + this.state.f_shares,
        };
        ...
        let orderdetails = {
          ...
          country: polcountry,
          social: "facebook",
          agegroup: polagegroup,
          gender: polgender,
          link: this.state.facebook_link,
          cost: 50.0,
          service: "post likes",
          count: this.state.f_Polikes,
        };
        ...
        let orderdetails = {
          ...
          country: scountry,
          social: "facebook",
          agegroup: palagegroup,
          gender: palgender,
          link: this.state.facebook_link,
          cost: 50.0,
          service: "page likes",
          count: this.state.f_Palikes,
        };
      ...
      var i_f_check = document.getElementById("i_f_check");
      // var i_l_check = document.getElementById("i_l_check");
      var fcountry = document.getElementById("i_f_country").value;
      ...
      if (i_f_check.checked) {
        let orderdetails = {
          ...
          agegroup: fagegroup,
          gender: fgender,
          link: this.state.insta_link,
          cost: 50.0,
          service: "followers",
          count: this.state.i_followers,
        };
      ...
      var fcountry = document.getElementById("tw_f_country").value;
      ...
      if (tw_f_check.checked) {
        let orderdetails = {
          ...
          agegroup: fagegroup,
          gender: fgender,
          link: this.state.twitter_link,
          cost: 50.0,
          service: "followers",
          count: this.state.tw_followers,
        };
      ...
      var ti_f_check = document.getElementById("ti_f_check");
      var fcountry = document.getElementById("ti_f_country").value;
      ...
      <div style={{ backgroundColor: "white" }}>
        ...
        <div class="main">
          <div class="s-layout">
            ...
            {/* <!-- Content --> */}
            <main
              class="s-layout__content"
              style={{ height: "100%", marginTop: "50px", width: "100%" }}
            >
              <div>
                <div class="container">
                  <h3
                  ...
                  >
                    <div class="container" style={{ marginTop: "10px" }}>
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a
                            class="nav-link active menu1"
                            data-toggle="tab"
                            href="#menu1"
                            id="menu11"
                            onClick={() => this.changeNavLink("menu1")}
                          >
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/yt.png"
                              alt=""
                            />
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            ...
                            href="#menu2"
                            id="menu22"
                            onClick={() => this.changeNavLink("menu2")}
                          >
                            <img
                              class="button-enter__icon"
                        ...
                        <li class="nav-item">
                          <a
                            class="nav-link menu3"
                            data-toggle="tab"
                            href="#menu3"
                            id="menu33"
                            onClick={() => this.changeNavLink("menu3")}
                          >
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/ig.png"
                              alt=""
                            />
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            class="nav-link menu4"
                            data-toggle="tab"
                            href="#menu4"
                            id="menu44"
                            onClick={() => this.changeNavLink("menu4")}
                          >
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/tw.png"
                              alt=""
                            />
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            class="nav-link menu5"
                            data-toggle="tab"
                            href="#menu5"
                            id="menu55"
                            onClick={() => this.changeNavLink("menu5")}
                          >
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/tik.png"
                              alt=""
                            />
                          </a>
                        </li>
                        <li class="nav-item">
                          <a
                            class="nav-link menu6"
                            data-toggle="tab"
                            href="#menu6"
                            id="menu66"
                            onClick={() => this.changeNavLink("menu6")}
                          >
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/fillsurvey.png"
                              alt=""
                            />
                          </a>
                        </li>
                    ...
                    <div class="tab-content">
                      ...
                      >
                        ...
                        <div class="p-1 bg-light rounded rounded-pill shadow-sm mb-4">
                          <div class="input-group">
                            <input
                              type="search"
                              placeholder="https://www.youtube.com/watch.. or https://www.youtube.com/channel.."
                              value={this.state.youtube_link}
                              onChange={this.changeYLink}
                        ...
                        {/* set view count */}
                        {/* <form> */}
                        <div class="form-group" style={{ marginLeft: "5px" }}>
                          <img
                            class="button-enter__icon"
                          ...
                          <input
                            type="checkbox"
                            id="y_v_check"
                            checked={this.state.y_v_check}
                            onChange={this.changeYoutubeViewsStatus}
                            style={{
                              marginLeft: "5px",
                              height: "13px",
                              fontSize: "15px",
                        ...
                        <div class="form-group">
                          <h6 style={{ height: "37px", marginLeft: "10px" }}>
                            QTY :&nbsp;
                            <input
                              type="number"
                              onChange={this.changeViews}
                              id="y_v_input"
                              name="quantity"
                              min="100"
                              max="50000"
                        ...
                        <input
                          type="range"
                          id="y_v_range"
                          min={this.state.min_yviews}
                          max={this.state.max_yviews}
                          step="1"
                          value={this.state.y_views}
                          onChange={this.changeViews}
                          style={{ width: "100%" }}
                        />
                        ...
                        <output id="amount" name="amount" for="range">
                          {this.state.y_views}
                        </output>
                        ...
                        <form style={{ marginTop: "3%" }}>
                          <div class="form-group" style={{ marginLeft: "5px" }}>
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/registration.png"
                              alt=""
                              style={{ backgroundColor: "#ffffff" }}
                            />
                            <input
                              type="checkbox"
                              onChange={this.changeYoutubesubscribeStatus}
                              id="y_s_check"
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                          ...
                          <div class="form-group">
                            <h6 style={{ height: "37px", marginLeft: "10px" }}>
                              ...
                              <input
                                ...
                                id="y_s_input"
                                disabled="disable"
                                onChange={this.changeSubscribers}
                                name="quantity"
                                min="100"
                                max="500000"
                                style={{
                          ...
                          <input
                            ...
                            disabled="disable"
                            id="y_s_range"
                            min={this.state.min_ysub}
                            max={this.state.max_ysub}
                            step="1"
                            value={this.state.y_subscribe}
                            onChange={this.changeSubscribers}
                            style={{ width: "100%" }}
                          />
                          {/* <input type="range" class="custom-range" id="customRange1" min="1000" max="500000" value="0" name="range" oninput="amount.value=range.value" /> */}
                          <output id="amount" name="amount" for="range">
                            {this.state.y_subscribe}
                          </output>
                        </form>
                      </div>
                      ...
                      >
                        ...
                        <form>
                          <div class="form-group" style={{ marginLeft: "5px" }}>
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/like2.png"
                              alt=""
                              style={{ backgroundColor: "#ffffff" }}
                            />
                            <input
                              type="checkbox"
                              id="f_pol_check"
                              checked={this.state.f_pl_check}
                              onChange={this.changeFacebookPostlikeStatus}
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                                fontSize: "15px",
                          ...
                          <input
                            type="range"
                            id="f_pol_range"
                            min={this.state.min_fpolike}
                            max={this.state.max_fpolike}
                            step="1"
                            value={this.state.f_Polikes}
                            onChange={this.changePostLikes}
                            style={{ width: "100%" }}
                          />
                          {/* <input type="range" class="custom-range" id="customRange1" min="1000" max="500000" value="0" name="range" oninput="amount.value=range.value" /> */}
                        ...
                        <form>
                          ...
                          >
                            ...
                            <input
                              type="checkbox"
                              id="f_pal_check"
                              onChange={this.changeFacebookPagelikeStatus}
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                                fontSize: "15px",
                          ...
                          <input
                            ...
                            id="f_pal_range"
                            disabled="disable"
                            min={this.state.min_fpalike}
                            max={this.state.max_fpalike}
                            step="1"
                            value={this.state.f_Palikes}
                            onChange={this.changePageLikes}
                            style={{ width: "100%" }}
                          />
                          {/* <input type="range" class="custom-range" id="customRange1" min="1000" max="500000" value="0" name="range" oninput="amount.value=range.value" /> */}
                        ...
                        <form>
                          ...
                          >
                            <img
                              class="button-enter__icon"
                              src="assets/img/icons/share2.png"
                              alt=""
                              style={{ backgroundColor: "#ffffff" }}
                            />
                            <input
                              type="checkbox"
                              id="f_s_check"
                              onChange={this.changeFacebookShareStatus}
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                                fontSize: "15px",
                          ...
                          <input
                            ...
                            id="f_s_range"
                            disabled="disable"
                            min={this.state.min_fshares}
                            max={this.state.max_fshares}
                            step="1"
                            value={this.state.f_shares}
                            onChange={this.changeFShares}
                            style={{ width: "100%" }}
                          />
                          {/* <input type="range" class="custom-range" id="customRange1" min="1000" max="500000" value="0" name="range" oninput="amount.value=range.value" /> */}
                      ...
                      >
                        ...
                        <form>
                          <div class="form-group" style={{ marginLeft: "5px" }}>
                            ...
                            <input
                              type="checkbox"
                              checked={this.state.i_fol_check}
                              id="i_f_check"
                              onChange={this.changeInstagramFollowersStatus}
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                                fontSize: "15px",
                          ...
                          <div class="form-group">
                            <h6 style={{ height: "37px", marginLeft: "10px" }}>
                              ...
                              <input
                                type="number"
                                id="i_f_input"
                                onChange={this.changeIFollowers}
                                name="quantity"
                                min="100"
                                max="500000"
                                style={{
                          ...
                          <input
                            ...
                            max="500000"
                            step="1"
                            value={this.state.i_followers}
                            onChange={this.changeIFollowers}
                            style={{ width: "100%" }}
                          />
                          {/* <input type="range" class="custom-range" id="customRange1" min="1000" max="500000" value="0" name="range" oninput="amount.value=range.value" /> */}
                          <output id="amount" name="amount" for="range">
                            {this.state.i_followers}
                          </output>
                        </form>
                      ...
                      >
                        ...
                        <form>
                          <div class="form-group" style={{ marginLeft: "5px" }}>
                            ...
                            <input
                              type="checkbox"
                              checked={this.state.tw_fol_check}
                              id="t_f_check"
                              onChange={this.changeTwitterFollowersStatus}
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                                fontSize: "15px",
                          ...
                          <div class="form-group">
                            <h6 style={{ height: "37px", marginLeft: "10px" }}>
                              ...
                              <input
                                type="number"
                                id="t_f_input"
                                onChange={this.changeTwFollowers}
                                name="quantity"
                                min="100"
                                max="500000"
                                style={{
                      ...
                      >
                        ...
                        <h6 style={{ marginLeft: "10px", marginTop: "-18px" }}>
                          Paste TikTok URL or enter keywords to search
                        </h6>
                        ...
                        <form>
                          <div class="form-group" style={{ marginLeft: "5px" }}>
                            ...
                            <input
                              type="checkbox"
                              checked={this.state.ti_fol_check}
                              id="ti_f_check"
                              onChange={this.changeTiktokFollowersStatus}
                              style={{
                                marginLeft: "5px",
                                height: "13px",
                                fontSize: "15px",
                          ...
                          <div class="form-group">
                            <h6 style={{ height: "37px", marginLeft: "10px" }}>
                              ...
                              <input
                                type="number"
                                id="ti_f_input"
                                onChange={this.changeTtFollowers}
                                name="quantity"
                                min="100"
                                max="500000"
                                style={{
                          ...
                          <input
                            ...
                            max="500000"
                            step="1"
                            value={this.state.tt__followes}
                            onChange={this.changeTtFollowers}
                            style={{ width: "100%" }}
                          />
                          {/* <input type="range" class="custom-range" id="customRange1" min="1000" max="500000" value="0" name="range" oninput="amount.value=range.value" /> */}
                          <output id="amount" name="amount" for="range">
                            {this.state.tt__followes}
                          </output>
                        </form>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="col-md-6">
                          <h4>
                            <strong>{this.state.total_price}</strong>
                          </h4>
                        </div>
                        <br />
                      </div>
